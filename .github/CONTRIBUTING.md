...
4. Для каждого **PR** необходимо оставить описание на русском языке
5. Вопросы по iOS-приложению решаем со мной в [почте](mailto:o.n.eremenko@gmail.com?subject=[GitHub]-SwiftUI-SotkaApp), [телеграм](http://t.me/oleg991) или в **issue** с подробным описанием проблемы
6. Вопросы по бэкенду/сайту - c Антоном в [почте](mailto:anton@workout.su?subject=[GitHub]-SwiftUI-SotkaApp) или в **issue** с подробным описанием проблемы
