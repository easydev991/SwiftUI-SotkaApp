...
@MainActor
struct StatusManagerResetProgramTests {
    /// Создает StatusManager с моками
    private func createStatusManager() -> StatusManager {
        StatusManager(
    ...
    func resetProgramOffline() async throws {
        ...
        await statusManager.resetProgram(client: mockStatusClient, context: context)
